...
RSpec.describe 'category/index', type: :feature do
  describe 'after log in' do
    before(:each) do
      ...
      @category2 = Category.create(name: 'Electronics', icon: 'https://media.istockphoto.com/id/1389937723/vector/cartoon-planet-earth-3d-vector-icon-on-white-background.jpg?s=2048x2048&w=is&k=20&c=eOyTJtouj1h2HG9_NhiZfLxzKq4Gp8GNCUlxqVfJMx4=', author_id: @user.id)
